...
# HOW TO CHOOSE s AND t?
# GIVEN A GRAPH WITH n NODES AND AVERAGE DEGREE d,
# IF WE TAKE s,t SUCH THAT n(d/n)^t >= s, THEN A K_s,t SUBGRAPH EXISTS WITH LARGE PROBABILITY
